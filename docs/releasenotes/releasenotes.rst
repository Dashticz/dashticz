...
* Topbar: enabling the optional clock keeps the logo and screen selector left, centers the clock, and keeps all configuration controls at the far-right edge.
