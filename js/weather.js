        ...
        $('.containsweather').each(function () {
          ...
          if (typeof weather.current_observation === 'undefined') {
            ...
            curfull
              .find('.weather')
              .html(
                '<p style="font-size:10px; width:100px;">Location ERROR</p>'
              );
          } else {
...
function loadWeatherFull(location, country) {
  if (
    ...
    $('div.containsweatherfull').html(
      '<div class="weatherfull"><div class="col-xs-3 transbg"></div><div class="col-xs-3 transbg"></div><div class="col-xs-3 transbg"></div><div class="col-xs-3 transbg"></div></div>'
    );
          ...
          if (typeof currentforecast.forecast === 'undefined') {
            ...
            for (var i = start; i < start + 4; i++) {
              ...
              html =
                ...
                '<br />' +
                date.format(settings['shortdate']) +
                '</div>';
              ...
              html +=
                '<div class="temp"><span class="dayT">' +
                hightemp +
                _TEMP_SYMBOL +
                '</span><span class="nightT">' +
                lowtemp +
                _TEMP_SYMBOL +
                '</span></div>';
