...
var DT_camera = {
  ...
  run: function(me) {
    ...
    me.block.videoUrl = isDefined(me.block.videoUrl)? me.block.videoUrl : me.block.imageUrl;
    ...
    setInterval(function() {
      DT_camera.reloadImage(me.block.imageUrl, me.mountPoint.slice(1) + "_camImage");
    }, refreshtime);
